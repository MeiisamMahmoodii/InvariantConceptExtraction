...
| Geography | currency_of | 186 | 139 | 1.338 | 0.942 |
...
The geography common-subject set is 174 countries, and the science common-subject set is 118 elements. Both pass the 50-subject requirement. `period_of` comes from the Royal Society of Chemistry fact box and is joined to Wikidata elements through the recorded atomic-number identity; period is never derived from atomic number.
